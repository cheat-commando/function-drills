...
let nameGreeting = nameCheck("Louis")
...
//CODE HERE
function theEliminator(arr, eliminate) {
...
//CODE HERE
function getChocoFrogs(gold) {
  return Math.floor(gold / 3)
}

let totalFrogs = getChocoFrogs(35)
